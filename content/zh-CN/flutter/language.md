...
message protocol_language_inquire_reply
{
    ...
    language cur_language = 2; // 设备当前语言。
    ...
    bool azerbaidzhan_support = 41; // 1bytes阿塞拜疆
}
```
...
| `cur_language` | `language` | 1bytes 设置语言，0x01中文 0x02英语... |
...
| `cur_language` | `language` | 设备当前语言。 |
| `chinese_support` | `bool` | 1bytes 中文 |
| `english_support` | `bool` | 1bytes 英语 |
| `german_support` | `bool` | 1bytes 德语 |
| `spanish_support` | `bool` | 1bytes 西班牙语 |
| `italian_support` | `bool` | 1bytes 意大利语 |
| `janpanese_support` | `bool` | 1bytes 日语 |
| `russian_support` | `bool` | 1bytes 俄罗斯语 |
| `portuguese_support` | `bool` | 1bytes 葡萄牙语 |
| `french_support` | `bool` | 1bytes 法语 |
| `korean_support` | `bool` | 1bytes 韩语 |
| `polish_support` | `bool` | 1bytes 波兰语 |
| `czech_support` | `bool` | 1bytes 捷克语 |
| `slovak_support` | `bool` | 1bytes 斯洛伐克语 |
| `Hungarian_support` | `bool` | 1bytes 匈牙利语 |
| `greek_support` | `bool` | 1bytes 希腊语 |
| `lithuanian_support` | `bool` | 1bytes 立陶宛语 |
| `latvian_support` | `bool` | 1bytes 拉脱维亚语 |
| `estonian_support` | `bool` | 1bytes 爱沙尼亚语 |
| `bulgarian_support` | `bool` | 1bytes 保加利亚语 |
| `malay_support` | `bool` | 1bytes 马来语 |
| `indonesian_support` | `bool` | 1bytes 印尼语 |
| `thai_support` | `bool` | 1bytes 泰语 |
| `vietnamese_support` | `bool` | 1bytes 越南语 |
| `hebrew_support` | `bool` | 1bytes 希伯来语 |
| `devanagari_support` | `bool` | 1bytes 天城文 |
| `turkey_support` | `bool` | 1bytes 土耳其语 |
| `romanian_support` | `bool` | 1bytes 罗马尼亚语 |
| `dutch_support` | `bool` | 1bytes 荷兰语 |
| `ukrainian_support` | `bool` | 1bytes 乌克兰语 |
| `arabic_support` | `bool` | 1bytes 阿拉伯语 |
| `farsi_support` | `bool` | 1bytes 波斯语 |
| `trad_chinese_support` | `bool` | 1bytes 中文繁体 |
| `sweden_support` | `bool` | 1bytes 瑞典 |
| `burmese_support` | `bool` | 1bytes 缅甸 |
| `khmer_support` | `bool` | 1bytes高棉语 |
| `bengali_support` | `bool` | 1bytes孟加拉语 |
| `slovene_support` | `bool` | 1bytes斯洛文尼亚 |
| `hrvatski_support` | `bool` | 1bytes克罗地亚 |
| `azerbaidzhan_support` | `bool` | 1bytes阿塞拜疆 |
