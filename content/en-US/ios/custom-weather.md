---
docId: ios-custom-weather
locale: en-US
title: iOS ZS Custom Weather
description: Write the custom weather payload used by ZS projects.
platform: iOS
slug: ios/custom-weather
order: 113
status: published
version: v2.0
---

# iOS ZS Custom Weather

## Overview

Write the custom weather payload used by ZS projects.

## Swift example

```swift
var data =  protocol_zs_weather_operate()
         data.switchFlag = true
         var item = protocol_zs_weather_detail_data_item()
         ...
         item.curMaxTemp = 33
         item.curMinTemp = 26
         item.weatherType = .zsTornado
         var item2 =  protocol_zs_weather_sunrise_item()
         item2.sunriseHour = 8
         item2.sunsetHour = 18
         ...
         CreekInterFace.instance.setZSWeather(model: data) {
