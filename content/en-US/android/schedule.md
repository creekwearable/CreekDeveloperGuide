...
locale: en-US
title: Android Schedules
description: Read and configure device schedules.
platform: Android
...
Read and configure device schedules.
...
var operate =  Calendar.protocol_calendar_operate()
  ...
  item.endHour = 11
  item.endMinute = 0
  item.content = ByteString.copyFrom("Attend meeting".toByteArray())
